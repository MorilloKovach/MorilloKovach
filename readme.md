...
<p align="center">
  ...
  <a href="https://www.linkedin.com/in/santiago-morillo/" target="_blank">
...
* **[OrientaTec](https://orientatec.com.ar/)**
  * **Descripción:** Sitio para encontrar Escuelas Técnicas y sus modalidades en La Matanza, Morón y Hurlingham..
  * **Tecnologías:** `HTML`, `CSS`, `JavaScript`, `PHP`, etc.

* **[Proyecto de Halloween (2024)](https://tecnica6lam.vercel.app/)**
  * **Descripción:** Aplicación creada utilizando Firebase para poder manejar las preinscripciones de los alumnos hacia la Técnica 6.
  * **Tecnologías:** `React`, `CSS`, etc.
...
- **Estudios Universitarios:** Universidad Nacional de La Matanza *Ingeniería en Informática*
- **Olimpiadas:** UNLaM - UNSaM – Olimpiada Informática Argentina
- **Bootcamps/Plataformas:** 
  - Coderhouse & Platzi (Stack MERN)
  - HackerRank (Problem Solving Basic and Intermediate)
  - Platzi (English Intermediate Course)
